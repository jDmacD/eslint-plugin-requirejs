/**
 * @hackee James MacDonald
 * Altered so that the rule ALWAYs reformats indents, as opposed to only reformatting on a line duplicate.
 * Also altered the formating slightly, added tabbing
 * TODO: make this it's own rule or an option for this rule.
 * If you are working on this code use https://babeljs.io/repl/ to make it easier to follow
 */
...
function create(context) {
    ...
    function check(setting, node, list, format) {
        ...
        if ((isLongerThan(val, lines) || isAlways(val)) && /*hasDuplicates(lines)*/ true) { // setting this to TRUE causes it to ALWAYS reformat names and paths
